...
namespace CarSelling.Data.Migrations
{
    ...
    [Migration("20240417180259_IsActiveForSoftDelete")]
    partial class IsActiveForSoftDelete
    {
            ...
            modelBuilder.Entity("CarSelling.Data.Models.Car", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("0eb30c31-3214-446c-87e9-d85dc0654474"),
                        ...
                        new
                        {
                            Id = new Guid("5c19aaf5-7ce8-4da3-a89c-6df64731e773"),
                            CategoryId = 1,
                            CreatedOn = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Description = "It is very good car with low mileage and very economical engine, it is a diesel engine with 235 horsepower!",
                            HorsePower = 0,
                        ...
                        new
                        {
                            Id = new Guid("65700234-7493-4aed-b525-91644ef195ac"),
                            CategoryId = 3,
                            CreatedOn = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
